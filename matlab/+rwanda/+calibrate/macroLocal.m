...
function x = macroLocal(x)
    ...
    x.c5_y_gap = 0.20; % Foreign demand
    ...
    x.c1_roc_cpi = 0.03; 0.10; % Output gap
    x.c2_roc_cpi = 0.02; 0.04; % Real exchange rate gap
    x.c3_roc_cpi = 0; % Real exchange rate gap change

    % Inflation expectations
    x.c1_roc_cpi_exp = 0.6;
    ...
    x.c1_prem = 0.1; 0.5; % Response in interest premium to lending conditions
